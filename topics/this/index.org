...
#+SUBTITLE: Using of Emacs, Org and Pelican to make this site..
#+CATEGORY: Meta
#+SETUPFILE: ~/org-pub/topics/setup.org
#+TAGS: emacs,org,python,pelican,web

This web site is written with Emacs [[Http://orgmode.org][org-mode]].  It's source is exported with [[https://github.com/brettviren/orgonpy][OrgOnPy]] and [[http://blog.getpelican.com/][Pelican]].  This topic contains notes on how it is done.
...
* Testing section closed time stamps
  CLOSED: [[2015-01-24 Sat 10:20]]

This section was created with a closed date.
